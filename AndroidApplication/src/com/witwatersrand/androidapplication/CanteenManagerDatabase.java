...
public class CanteenManagerDatabase {
	...
	public MenuItem[] getMenu() throws SQLException {
		...
		int iRow = myCursor.getColumnIndex(KEY_ROWID);
	...
	public void createOrderTable(MenuItem[] order) {
		_numberOrders++;
